...
public class BrandController {
    ...
    @Operation(summary = "Create a new brand", description = "Create a new product brand (Admin/Employee only)")
    @ApiResponses(value = {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
    @Operation(summary = "Update a brand", description = "Update an existing product brand (Admin/Employee only)")
    @ApiResponses(value = {
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYEE')")
    @Operation(summary = "Delete a brand", description = "Delete a product brand (Admin/Employee only)")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Page<BrandDTO>> getAllBrands(
        ...
        log.debug("Fetching all brands with pagination: page={}, size={}, sortBy={}, sortDir={}", page, size, sortBy,
                sortDir);
