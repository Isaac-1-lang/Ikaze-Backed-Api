...
public interface ReturnRequestRepository extends JpaRepository<ReturnRequest, Long> {
     ...
     */
    Page<ReturnRequest> findByCustomerIdAndStatus(UUID customerId, ReturnRequest.ReturnStatus status, Pageable pageable);
    ...
    /**
     * Find return requests that can be appealed (denied status and no existing appeal)
     */
    ...
    /**
     * Find return requests with all related data loaded
     */
    @Query("SELECT DISTINCT rr FROM ReturnRequest rr " +
           ...
           "WHERE rr.id = :id")
    Optional<ReturnRequest> findByIdWithAllData(@Param("id") Long id);
