...
public interface OrderActivityLogRepository extends JpaRepository<OrderActivityLog, Long> {
       ...
       /**
        * Find all activity logs for a specific shop order, ordered by timestamp
        */
       List<OrderActivityLog> findByShopOrder_IdOrderByTimestampAsc(Long shopOrderId);
       ...
       /**
        * Find activities by reference (e.g., all activities related to a specific
        * return request)
        */
